            ...
            <div className="row">
                <div id="picLinks" className="col-12 col-lg-4 container">
                    <div className="row">
                        ...
                        <div className="col-6 col-lg-12">
                            <a className="a" href="./images/Claire_Phillips_Resume2.pdf" target="_blank" rel="noreferrer">My Resume</a>
                ...
                <div className="col-12 col-lg-8">
                    ...
                    <p>
                        ...
                        You can also find learn more about me in my <a className="a" href="./images/Claire_Phillips_Resume2.pdf" target="_blank" rel="norfererrer">resume.</a>
                    </p>
                </div>
            </div>
        </div>
