        ...
        <div className="container">
            <div className="row">
                <div className="col-12 col-lg-4">
                    <img id="headshot" className="img-fluid" src ="./images/claire2.jpg" alt="A head shot of Claire Phillips" />
                ...
                <div className="col-12 col-lg-8">
                    ...
                    <p>
                        ...
                        completed on my  <a href="https://github.com/ClairePhillips51?tab=repositories" target="_blank" rel="noreferrer">GitHub page</a>.
